...
nominal_MESS_input_path = os.getcwd() + '/ch2o+oh/'
nominal_MESS_input = 'ch2o+oh.inp'
...
model = MSI.PAPR_MESS(nominal_MESS_input_path, nominal_MESS_input,
                                        ...
                                        { 'colrel_FactorOne': [temperature_list, pressure_list, pertubation_percent],
                                          ...
                                          #  'B2_ImaginaryFrequency_1':[temperature_list, pressure_list, pertubation_percent],
                                            ...
                                            'P0_Frequencies_1':[temperature_list, pressure_list, pertubation_percent],
                                            'P0_SymmetryFactor_1':[temperature_list, pressure_list, pertubation_percent],
