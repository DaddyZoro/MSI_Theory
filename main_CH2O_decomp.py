...
'P1->P2'] # channel-specific rate constants of interest
...
nominal_MESS_input_path = os.getcwd() + '/CH2O_decomp/'
nominal_MESS_input = 'CH2O_decomp.inp'
...
model.fit_Cheb_rates(n_P, n_T, P_min=.01, P_max=100.0 T_min=250.0, T_max=5000.0, same_line_result=same_line_result) # fit rate constants into Chebyshev expressions
