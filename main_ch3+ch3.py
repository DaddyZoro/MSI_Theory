...
temperature_list = np.arange(290,700,10).tolist() + np.arange(700,3000,100).tolist() # K

#temperature_list = [290,296,370,407,474,513,539,577,700,810,906,1050,1200,1350,1525,1700,1900,2000,2200,2900] # K



#temperature_list = np.arange(300,700,10).tolist()

pressure_list = [[.5,1,2,4], ['[atm]']] # Torr will be converted into atm internally

pressure_list = [[.001], ['[atm]']] # Torr will be converted into atm internally

channels = ['W1->P1', 'W1->P2', 'W1->P3',
            'P1->P2', 'P1->P3',
            'P2->P3',]
...
nominal_MESS_input = 'c2h6rad.inp'
                                        ...
                                        { 
                                         ...
                                         # 'colrel_Sigmas': [temperature_list, pressure_list, pertubation_percent],
                                          ...
                                          'W1_HinderRotor_1':[temperature_list, pressure_list, pertubation_percent],
                                           ...
                                           'B2_HinderRotor_1':[temperature_list, pressure_list, pertubation_percent],
