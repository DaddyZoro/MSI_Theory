...
#import scipy
#import pylab
sys.path.append( "/tcghome/fgold/scripts" )
#sys.path.append( "/Users/franklin/Documents/trajectory/test_new_parser")
import me_parser
...
command = 'cp /tcghome/fgold/scripts/dsarrfit.x_cfg ' + path 
print command
os.system(command)
