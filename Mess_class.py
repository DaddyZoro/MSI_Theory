...
class Collision_Relaxation(Mess_Input):
    ...
    def perturb_fraction(self,org_fraction,percentage_diff):
        ...
        if first_fraction_perturbed>1:
            second_fraction = fraction_list[1]
            second_fraction_perturbed = second_fraction * (1+percentage_diff)
            first_fraction_calculated = 1 - second_fraction_perturbed
            fraction_list_perturbed2 = [first_fraction_calculated,second_fraction_perturbed]
            print(fraction_list_perturbed2)
        if first_fraction_perturbed>1:
            return fraction_list_perturbed2
        else:
