...
gas_cheby = ct.Solution('/home/jmp/MSI_Theory/ch3+oh/testing_cheby_fits.cti')
gas_original = ct.Solution('/home/jmp/MSIFormaldehyde_CarlyOct23/MSI/data/branching_reaction_study/usc_mech_nov_16_2023_branching_reactions.cti')
...
df = pd.read_csv('/home/jmp/MSI_Theory/PAPR-MESS_calculation/CH3+OHtripletabs/calculation_29/nominal/T_rate.csv', skiprows=3)
