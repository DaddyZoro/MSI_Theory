...
lines=load_text_file('/home/jmp/MSI_Theory/PAPR-MESS_calculation/ch4oabs/calculation_7/'+file_name)
...
build_reaction_string(p_list, temp_dict = {'R':'CH3 + OH', 'P7':'CH4 + O'})
