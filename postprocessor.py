...
################################################################################
                    ...
                    #    print('this value is less than zero',self.key,self.channel)
################################################################################
...
################################################################################
                        # if (chan_rate<0).any() == True:
                        #     print((chan_rate<0).any(),self.key,self.channel)
                        #     print(chan_rate[chan_rate >= 0].min(),self.pressure )
                            

                        #     chan_rate[chan_rate <0] = chan_rate[chan_rate >= 0].min()
                        #     print('WE NEED TO REMOVE THIS AFTER WE ARE DONE')
################################################################################
